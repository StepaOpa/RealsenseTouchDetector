        ...
        try:
            ...
            with self.camera:
                ...
                if color_intrinsics and depth_intrinsics:
                    ...
                    # В TouchDetector.run(), после запуска камеры:
                _, depth_intrinsics = self.camera.get_intrinsics()
                if self.touch_processor is not None and depth_intrinsics:
                    self.touch_processor.set_intrinsics(depth_intrinsics)
